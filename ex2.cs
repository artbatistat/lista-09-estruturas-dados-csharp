...
Hashtable CPF_Telefone = new Hashtable(); 
        ...
        pesquisarCPF(CPF_Telefone);

        Console.ReadLine();

static void pesquisarCPF(Hashtable CPF_Telefone)
    {
        Console.WriteLine("Digite o CPF para pesquisar:");
        string CPF = Console.ReadLine();
        Console.WriteLine("CPF: {0}, Telefone: {1}",CPF,CPF_Telefone[CPF]);
